...
// Task validation lives in dataSyncTaskValidation.ts; re-exported here so
// gateway, editor, and preflight modules keep a single import source.
export {
  canUseDataSyncRowErrorIsolation,
  validateDataSyncTask,
} from './dataSyncTaskValidation';
