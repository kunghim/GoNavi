...
export function AIApplyAgentDataDirectory(arg1, arg2) {
  return window['go']['aiservice']['Service']['AIApplyAgentDataDirectory'](arg1, arg2);
}
...
export function AIClearAgentData() {
...
export function AIGetAgentDataDirectoryInfo() {
  return window['go']['aiservice']['Service']['AIGetAgentDataDirectoryInfo']();
}
...
export function AIOpenAgentDataDirectory() {
  return window['go']['aiservice']['Service']['AIOpenAgentDataDirectory']();
}
...
export function AISelectAgentDataDirectory(arg1) {
  return window['go']['aiservice']['Service']['AISelectAgentDataDirectory'](arg1);
}
