...
- [Wails CLI](https://wails.io/docs/gettingstarted/installation)，由项目本地安装
...
node tools/project-tools.mjs wails dev  # 完整热重载
...
node tools/project-tools.mjs wails build -clean   # 发布前推荐
```
